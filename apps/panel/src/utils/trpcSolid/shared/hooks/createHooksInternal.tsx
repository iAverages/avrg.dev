...
import { TRPCContext, type TRPCContextProps, type TRPCContextState } from "../../internals/context";
...
export function createHooksInternal<TRouter extends AnyRouter>(config?: CreateTRPCSolidOptions<TRouter>) {
    ...
    >(
        ...
        console.log("useQuery", pathAndInput);
        console.log("useQuery", pathAndInput());
        console.log("getArrayQueryKey", getArrayQueryKey(pathAndInput()));
        return __useQuery(() => ({
            queryKey: pathAndInput()[0],
            queryFn: () => {
                return (ctx.client as any).query(...getClientArgs(pathAndInput(), opts?.()));
            },
            ...(withCtxOpts?.() as any),
    ...
    function useMutation<TPath extends keyof TMutationValues & string, TContext = unknown>(
        ...
        return __useMutation(() => ({
            mutationFn: (input) => {
                ...
                return (ctx.client as any).mutation(...getClientArgs([actualPath, input], opts));
            },
            ...withCtxOpts(),
    ...
    function useInfiniteQuery<TPath extends TInfiniteQueryNames & string>(
        ...
        return __useInfiniteQuery(() => ({
            ...
            queryFn: (queryFunctionContext) => {
                ...
                return (ctx.client as any).query(...getClientArgs([pathAndInput()[0], actualInput], opts?.()));
            },
            ...(withCtxOpts() as any),
